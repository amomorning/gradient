...
public class PolyTrans {
    ...
    private void transtoPlane() {
        for (int i = 0; i < size; i++) {
            ...
            WB_Transform3D T = new WB_Transform3D(centers.get(i), vec, center_f, new WB_Vector(0, 0, 1));
            //
